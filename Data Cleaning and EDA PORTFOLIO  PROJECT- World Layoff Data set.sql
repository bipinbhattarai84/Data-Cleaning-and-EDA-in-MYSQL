...
-- Self join on the table to update the blank values of the industry 
...
-- 4. REMOVING THE ROWNUMBER COLUMN I CREATED TO FIND THE DUPLICATE ROWS  
alter table layoffs_staging 
...
select company,dat, total_laid, sum(total_laid) over( partition by company order by  dat asc  ) as rolling_total from rollingtotal
 ...
 -- Rank on the basis of number of employess fired with respect to the company and date 
